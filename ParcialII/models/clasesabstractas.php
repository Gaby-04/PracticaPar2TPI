...
abstract class Tiburon extends Peces{
    ...
    public static function descripcion(){
        return "son un superorden de condrictios conocidos comúnmente con el nombre de tiburones o escualos. Algunos grandes escualos, como el tiburón blanco y el toro, son conocidos a veces con el nombre de jaquetones";
    }
...
abstract class Pez_payaso extends Peces{
    ...
    public static function descripcion(){
        return "Es una subfamilia de peces marinos de la familia Pomacentridae, que engloba únicamente a los géneros Amphiprion y Premnas, cuyos componentes son conocidos como peces payaso o peces de las anémonas.";
    }
...
abstract class Estrella_mar extends Peces{
    ...
    public static function descripcion(){
        return "Estrellas de mar son una clase del filo Echinodermata de simetría pentarradial, con cuerpo aplanado formado por un disco pentagonal con cinco brazos o más.​ El nombre «estrella de mar» se refiere esencialmente a los miembros de la clase Asteroidea.";
    }
}
